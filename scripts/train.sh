...
MODEL=sia_pose_coco_decoder  # [sia_pose_simple, sia_pose_coco_decoder , sia_pose_coco_roi, sia_pose_coco_roi_best]
CUDA_VISIBLE_DEVICES=0,2 torchrun --nproc_per_node=2 train_pose.py \
       ...
       -BS 64 -EPOCH 150 -LR 5e-4 --SAVE -FRAMES 1 -VAL_BATCH_FREQ 100 -LOG 10 -WORKERS 12 -LR_BACKBONE 1e-5 -DET 20 -GRAD_CLIP 1 \
