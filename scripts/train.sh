...
MODEL=sia_pose_simple  # [sia_pose_simple, sia_pose_simple_dec , sia_pose_coco, sia_pose_posetrack]
# CUDA_VISIBLE_DEVICES=0 
torchrun --nproc_per_node=1 train_pose.py \
       -MODEL $MODEL -SIZE b16 \
       -ROOT /mnt/SSD2/coco2017/images \
       ...
       --RESUME weights/avak_b16_11.pt --FREEZE_BACKBONE \
