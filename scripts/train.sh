...
CUDA_VISIBLE_DEVICES=0 torchrun --nproc_per_node=1 train_pose.py \
       ...
       -BS 32 -EPOCH 200 -LR 5e-4 --SAVE -FRAMES 1 -VAL_BATCH_FREQ 10 -LOG 5 -WORKERS 12 -LR_BACKBONE 1e-5 -DET 20 -GRAD_CLIP 1 \
       -HEIGHT 480 -WIDTH 640 -FUSION_LAYERS 6,9,11 \
       -BACKBONE weights/avak_b16_11.pt --RESUME weights/sia_pose_coco_roi_best_b16_best.pt  \
